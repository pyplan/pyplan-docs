...
![enter image description here](/assets/mod_node_prop.png)
...
![enter image description here](/assets/model-code-tab1.png)
...
![enter image description here](/assets/model-blue.png)
...
![enter image description here](/assets/model-docs.png)
## Types of Nodes
The main elements for creating the app calculation logic are the following:

<img src="/assets/model-nodes-type.png"
...
![enter image description here](/assets/model-text-usage.png)
...
![enter image description here](/assets/model-install-lib.png)
...
![enter image description here](/assets/Mod_data_sources.jpg)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzA4NzgxNTcsLTg5ODAxNTIyNiwzMT
k4NDA2NjksMjAzNDg0Mzg0OSwxODM2NjM3MTI5LC02NTA1MjI4
OSwtMTQ4NTA3NTAxLC01NzU4NzE0NjksODE1MTkwODQ0LDU2OT
